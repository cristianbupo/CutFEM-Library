...
int main(int argc, char **argv) {
    ...
    for (int j = 0; j < iterations; ++j) {
        ...
        //double integral_face = integral_algoim<Levelset<2>, Fun_h>(funone, Thi, phi, INTEGRAL_INNER_EDGE_2D);
        ...
        if ((iterations == 1)) {
            ...
            Paraview<Mesh> background_mesh(Th, "Th.vtk");
            
            Paraview<Mesh> writer(Thi, "bulk.vtk");
            
            writer.writeActiveMesh(Thi, "ActiveMesh.vtk");
            writer.writeFaceStab(Thi, 0, "Faces.vtk");
#if defined(algoim)
            ...
            writer.writeAlgoimQuadrature(Thi, phi, -1, "AlgoimQuadrature.vtk");
            // writer.writeAlgoimQuadrature(Thi, qf, "Quadrature.vtk");
            writer.writeAlgoimQuadrature(Thi, phi, 2, "AlgoimQuadratureSurface.vtk");
#endif
        }
